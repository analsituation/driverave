...
import { checkDateIsEqual, checkIsToday, formatDate } from '@/utils/date'
      ...
      <div className='calendar__body'>
        {state.mode === 'days' && (
          <>
            ...
            <div className={clsx(inter.className, 'calendar__days')}>
          ...
          <div className='calendar__pick__items__container'>
            {state.monthsNames.map(monthsName => {
              const isCurrentMonth =
                new Date().getMonth() === monthsName.monthIndex && state.selectedYear === new Date().getFullYear()
